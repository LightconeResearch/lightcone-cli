...
The agent type's model is declared in `.claude/agents/lc-extractor.md` (edit the frontmatter `model:` field to change it). Spawn all in a single message (parallel). Show progress as results come in:
