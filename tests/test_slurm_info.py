...
class TestQueryQos:
    @patch("prism.dagster.slurm_info._run_command")
    @patch("prism.dagster.slurm_info.shutil.which", return_value="/usr/bin/sacctmgr")
    ...
    @patch("prism.dagster.slurm_info.shutil.which", return_value=None)
...
class TestDiscoverCluster:
    @patch("prism.dagster.slurm_info.query_partitions", return_value={})
    @patch("prism.dagster.slurm_info.query_user_associations", return_value=([], []))
    @patch("prism.dagster.slurm_info.query_qos", return_value={})
