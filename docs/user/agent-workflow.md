...
you're inside a project, you can also just hand off to the agent and
describe what you're working on — `astra.yaml` and the `lc` CLI keep
things tracked whether you go through a skill or not.
