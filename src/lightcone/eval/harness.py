...
Invoke the `/lightcone:cli` skill for the lc workflow (spec-code invariant, \
status interpretation, failure diagnosis) and `/lightcone:astra` for spec \
syntax (decisions, inputs/outputs, sub-analyses). Then for each output that \
needs materializing:
